public class App {
    public static void main(String args[]) {
        ...
        System.out.println("Does the array contain the element 4? - " + App.linearSearch(array, length, 4));
        System.out.println("Does the array contain the element 30? - " + App.linearSearch(array, length, 30));
